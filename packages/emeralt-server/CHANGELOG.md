...
* **server:** expose plugins ([1db3272](https://github.com/emeralt/emeralt/commit/1db3272))
* **server:** make upstream optional ([16b4d34](https://github.com/emeralt/emeralt/commit/16b4d34))
